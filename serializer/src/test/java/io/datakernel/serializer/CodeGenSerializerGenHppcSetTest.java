...
public class CodeGenSerializerGenHppcSetTest {
	...
	public void testCharSet() throws Exception {
		BufferSerializer<CharSet> serializer = getBufferSerializer(CharSet.class);
	...
	public void testShortSet() throws Exception {
		BufferSerializer<ShortSet> serializer = getBufferSerializer(ShortSet.class);
	...
	public void testIntSet() throws Exception {
		BufferSerializer<IntSet> serializer = getBufferSerializer(IntSet.class);
	...
	public void testLongSet() throws Exception {
		BufferSerializer<LongSet> serializer = getBufferSerializer(LongSet.class);
	...
	public void testFloatSet() throws Exception {
		BufferSerializer<FloatSet> serializer = getBufferSerializer(FloatSet.class);
	...
	public void testDoubleSet() throws Exception {
		BufferSerializer<DoubleSet> serializer = getBufferSerializer(DoubleSet.class);
	...
	@Ignore // TODO(vsavchuk): exception should be thrown when there is no appropriate serializer for class
	@Test(expected = Exception.class)
	public void throwsExceptionWhereThereIsNoAppropriateSerializerForClass() throws Exception {
		BufferSerializer<ObjectSetStringHolder> bufferSerializer = SerializerBuilder
				.newDefaultInstance(ClassLoader.getSystemClassLoader())
				.create(ObjectSetStringHolder.class);
		...
		byte[] array = new byte[1000];
		ByteBuf buf = ByteBuf.wrapForWriting(array);
		bufferSerializer.serialize(buf, testData1);
		bufferSerializer.deserialize(buf);
	}
}
