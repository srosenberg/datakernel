 ...
 * <p>
 * Let's consider some lifecycle details of this module:
 * <ul>
 * <li>
 ...
 * </li>
 * <li>
 * Start services concurrently starting at leaf graph nodes (independent
 ...
 * </li>
 * </ul>
 * <p>An ability to use {@link ServiceAdapter} objects lets to create a service
 * from any object by providing its {@link ServiceAdapter} and registering
 ...
 * object provider with @Worker or @Singleton annotation.
 * <p>
 * An application terminates if circular dependency found.
 */
public final class ServiceGraphModule extends AbstractModule {
    ...
    /**
     * Creates a service graph with default configuration. Such service graph
     * knows how to handle {@code Service, BlockingService, Closeable,
     * ExecutorService, Timer, DataSource, EventloopService, EventloopServer}
     * and {@code Eventloop} as the services.
     *
    ...
    /**
     * Creates new instance of a service graph.
     *
