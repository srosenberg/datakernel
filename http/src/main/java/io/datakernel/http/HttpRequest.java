...
/**
 * Represent the HTTP request which {@link AsyncHttpClient} send to
 * {@link AsyncHttpServer}. It must have only one owner in each  part of time.
 * After creating in server {@link HttpResponse} it will be recycled and you
 * can not use it later.
 * <p>
