...
import io.datakernel.config.util.InetAddresses;
import io.datakernel.config.util.Joiner;
import io.datakernel.config.util.Splitter;
...
import static io.datakernel.config.util.Preconditions.checkArgument;
import static io.datakernel.config.util.Preconditions.checkNotNull;
	...
	private static final class ConfigConverterInetSocketAddress extends ConfigConverterSingle<InetSocketAddress> {
		...
		protected InetSocketAddress fromString(String addressPort) {
			...
			if ("*".equals(addressStr)) {
				...
				InetAddress address = InetAddresses.forString(addressStr);
