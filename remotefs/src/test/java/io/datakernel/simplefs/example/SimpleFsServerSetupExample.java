...
public class SimpleFsServerSetupExample {
	 ...
	 *  Bear in mind that specified directories must not relate
	...
	public static void main(String[] args) throws IOException {
		...
		SimpleFsServer fileServer = SimpleFsServer.build(eventloop, executor, SERVER_STORAGE_PATH, TMP_STORAGE_PATH)
				.setListenPort(SERVER_PORT)
				.build();
