...
public class ExpressionTest {
	...
	public void test() throws IllegalAccessException, InstantiationException {
		...
		Class<Test> testClass = AsmBuilder.create(DefiningClassLoader.create(), Test.class)
	...
	public void test2() throws IllegalAccessException, InstantiationException {
		Class<Test2> testClass = AsmBuilder.create(DefiningClassLoader.create(), Test2.class)
				.withMethod("hash",
	...
	public void testComparator() {
		Comparator<TestPojo> comparator = AsmBuilder.create(DefiningClassLoader.create(), Comparator.class)
				.withMethod("compare",
						compare(TestPojo.class, "field1", "field2"))
				.newInstance();
	...
	public void testNeg() {
		...
		TestNeg testClass = AsmBuilder.create(DefiningClassLoader.create(), TestNeg.class)
	...
	public void testOperation() {
		...
		TestOperation testClass = AsmBuilder.create(DefiningClassLoader.create(), TestOperation.class)
	...
	public void testSH() {
		...
		TestSH testClass = AsmBuilder.create(DefiningClassLoader.create(), TestSH.class)
	...
	public void testBitMask() {
		TestBitMask testClass = AsmBuilder.create(DefiningClassLoader.create(), TestBitMask.class)
	...
	public void testCall() {
		TestCall testClass = AsmBuilder.create(DefiningClassLoader.create(), TestCall.class)
	...
	public void testArgument() {
		TestArgument testClass = AsmBuilder.create(DefiningClassLoader.create(), TestArgument.class)
	...
	public void testIterator() {
		...
		WriteAllListElement testClass = AsmBuilder.create(DefiningClassLoader.create(), WriteAllListElement.class)
	...
	public void testIteratorForArray() {
		...
		WriteArrayElements testClass = AsmBuilder.create(DefiningClassLoader.create(), WriteArrayElements.class)
				.withMethod("write", forEach(arg(0), new ForVar() {
					@Override
					public Expression forVar(Expression it) {
	...
	public void testCastPrimitive() {
		CastPrimitive testClass = AsmBuilder.create(DefiningClassLoader.create(), CastPrimitive.class)
	...
	public void testGetter() throws Exception {
		...
		Initializable intHolder = AsmBuilder.create(classLoader, Initializable.class)
				.withField("x", int.class)
		...
		Getter getter = AsmBuilder.create(classLoader, Getter.class)
	...
	public void testBuildedInstance() throws IllegalAccessException, InstantiationException {
		...
		Expression local = let(constructor(TestPojo.class, value(1)));
		Class<Test> testClass1 = AsmBuilder.create(definingClassLoader, Test.class)
				.withField("x", int.class)
				.withField("y", Long.class)
				.withMethod("compare", int.class, asList(TestPojo.class, TestPojo.class),
						compare(TestPojo.class, "field1", "field2"))
		...
		Class<Test> testClass2 = AsmBuilder.create(definingClassLoader, Test.class)
				.withField("x", int.class)
				.withField("y", Long.class)
				.withMethod("compare", int.class, asList(TestPojo.class, TestPojo.class),
						compare(TestPojo.class, "field1", "field2"))
	...
	public void testCompare() throws IllegalAccessException, InstantiationException {
		DefiningClassLoader definingClassLoader = DefiningClassLoader.create();
		Class<TestCompare> test1 = AsmBuilder.create(definingClassLoader, TestCompare.class)
	...
	public void testComparatorNullable() {
		...
		Comparator generatedComparator = AsmBuilder.create(classLoader, Comparator.class)
	...
	public void testAbstractClassWithInterface() throws Exception {
		DefiningClassLoader classLoader = DefiningClassLoader.create();
		TestAbstract testObj = AsmBuilder.create(classLoader, TestAbstract.class)
	...
	public void testMultipleInterfacesWithAbstract() {
		...
		final A instance = AsmBuilder.create(definingClassLoader, A.class, asList(B.class, C.class))
	...
	public void testMultipleInterfaces() {
		final DefiningClassLoader definingClassLoader = DefiningClassLoader.create();
		final B instance = AsmBuilder.create(definingClassLoader, B.class, Collections.<Class<?>>singletonList(C.class))
				.withMethod("b", value(43))
				.withMethod("c", value("44"))
				.newInstance();
	...
	public void testNullableToString() {
		final DefiningClassLoader definingClassLoader = DefiningClassLoader.create();
		final B instance = AsmBuilder.create(definingClassLoader, B.class)
	...
	public void testArraySet() {
		final DefiningClassLoader definingClassLoader = DefiningClassLoader.create();
		final TestArraySet instance = AsmBuilder.create(definingClassLoader, TestArraySet.class)
	...
	public void testCallStatic() {
		final DefiningClassLoader definingClassLoader = DefiningClassLoader.create();
		final TestCallStatic instance = AsmBuilder.create(definingClassLoader, TestCallStatic.class)
	...
	public void testIsNull() {
		final DefiningClassLoader definingClassLoader = DefiningClassLoader.create();
		final TestIsNull instance = AsmBuilder.create(definingClassLoader, TestIsNull.class)
	...
	public void testNewArray() {
		final DefiningClassLoader definingClassLoader = DefiningClassLoader.create();
		final TestNewArray instance = AsmBuilder.create(definingClassLoader, TestNewArray.class)
